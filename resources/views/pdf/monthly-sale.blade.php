...
<head>
    <meta charset="utf-8">
    <title>monthly-sale-{{ $monthName }}-{{ $year }}.pdf</title>
    <style>
        @page {
            margin: 30px;
        }
...
<body>
    <div class="container">
        ...
        <div class="page-title">
            <div class="title-box">MONTHLY SALE STATEMENT</div>
        </div>
        ...
        <table class="amounts-table">
            ...
            <tr>
                <td class="label-col">VAT Amount ({{ number_format($vatPercentage, 2) }}%)</td>
                <td class="amount-col">{{ number_format($vatAmount, 2) }}</td>
            </tr>
            <tr>
                <td class="label-col">Net Sale (Excl. VAT)</td>
                <td class="amount-col">{{ number_format($netAmount, 2) }}</td>
            </tr>
        </table>
